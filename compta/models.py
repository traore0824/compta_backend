...
class APITransaction(models.Model):
    ...
    balance = models.DecimalField(decimal_places=4, max_digits=20, default=0.0)
...
class UserTransactionFilter(models.Model):
    ...
    network = models.JSONField(null=True, blank=True, default=list)
    api = models.JSONField(null=True, blank=True, default=list)
